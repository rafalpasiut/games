...
public class SudokuCellEntityResource {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/sudokuGetSaved")
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/sudokuNew")
    public SudokuBoardWebDTO generateNewGame(@RequestParam Integer level) {
        sudokuGenerator.nextBoard(level);
        return sudokuGenerator.getSudokuDTO();
    }

    @RequestMapping(method = RequestMethod.PUT, value = "/sudokuSaveSudoku", consumes = MediaType.APPLICATION_JSON_VALUE)
